...
<template>
  <div class="flex justify-center gap-3">
    ...
    <div
      class="pagination__item"
      :class="{ disabled: modelValue === total }"
      @click="$emit('update:modelValue', modelValue + 1)"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path
...
.pagination__item {
  user-select: none;
  @apply flex justify-center items-center w-[24px] h-[24px] text-gray-300 hover:text-white text-xs bg-gray-800 hover:bg-gray-900 shadow-white-small rounded cursor-pointer;
