...
<template>
  <div
    class="__block flex justify-between items-center rounded w-full bg-blue-500 px-12 py-8"
  >
    <div>
      <h2 class="text-white mt-0">{{ block.title }}</h2>
      <p class="text-white mb-0">{{ block.subtitle }}</p>
    </div>
